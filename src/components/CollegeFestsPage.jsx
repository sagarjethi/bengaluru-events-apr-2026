...
// Recurring Bengaluru college fests. Status: 'tracking' until verified 2026 dates land.
const FESTS = [
  {
    name: 'Pravega',
  ...
  },
  {
    ...
    area: 'V V Puram',
    type: 'Tech',
    blurb: 'Bangalore Institute of Technology\'s technical fest with hackathons and workshops.',
    site: 'https://bit-bangalore.edu.in/',
    typicalMonth: 'Spring',
    status: 'tracking',
  },
  {
    name: 'Inceptor',
    college: 'NMAM Institute of Technology · MITE Bengaluru affiliates',
    area: 'Various',
    type: 'Tech',
    blurb: 'Pan-Bengaluru technical inter-college fest with hackathons, competitive programming, and design contests.',
    site: '#',
    typicalMonth: 'Spring',
    status: 'tracking',
  },
  {
    ...
    type: 'Cultural',
    blurb: "Bengaluru's most iconic cultural fest — music, drama, debate, fashion. Joshua's draws crowds from across the country.",
